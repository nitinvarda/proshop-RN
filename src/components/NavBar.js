...
export default function NavBar(props) {
  ...
  return (
    <View style={{backgroundColor:Assets.Colors(colorScheme).secondary,paddingVertical:10,zIndex:101}} >
        ...
        <View centerV row style={{marginHorizontal:20,}}>
            ...
            <Text style={{fontWeight:'bold',fontSize:20,marginLeft:10,color:Assets.Colors(colorScheme).textPrimary}}>{props.screenName}</Text>
        </View>
    </View>
  )
}
